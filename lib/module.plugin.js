import { log, getTrackingUserId, viewedProduct, setCustomerEmail } from './ralph-module-hello-retail.utils'
    ...
    if (mutation.type === 'events/push') {
      ...
      switch (eventType) {
        ...
        case 'user:login':
          ...
          // setCustomerEmail(eventData.__ob__?.dep.subs[0]?.value?.auth?.user);
          break;
        ...
        case 'newsletter:subscribe':
          ...
          setCustomerEmail(eventData.email);
          break;
